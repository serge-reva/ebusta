...
func (c *BotClient) SendMessage(ctx context.Context, chatID int64, text string, keyboard *tgpresenter.InlineKeyboardMarkup) (int, error) {
	...
	logTelegramRequest(ctx, "sendMessage", chatID, 0, text, keyboard)
...
func (c *BotClient) EditMessage(ctx context.Context, chatID int64, messageID int, text string, keyboard *tgpresenter.InlineKeyboardMarkup) error {
	...
	logTelegramRequest(ctx, "editMessageText", chatID, messageID, text, keyboard)
...
func logTelegramRequest(ctx context.Context, method string, chatID int64, messageID int, text string, keyboard *tgpresenter.InlineKeyboardMarkup) {
	payload := "null"
	if keyboard != nil {
	...
	log := logger.GetGlobal().WithFields(map[string]interface{}{
		"method":        method,
		"chat_id":       chatID,
	...
	log.DebugCtx(ctx, "telegram-bot outbound request")
}
